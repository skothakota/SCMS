	...
	<div class="container">
		...
		<aside id="fh5co-hero">
			<div class="flexslider">
				<ul class="slides">
                                    <form action="ViewStudentForms.jsp" mehtod="post">
                                        <table>
                                            <tr><th>Select Student Registration No:</th><td><select name="regno">
                                                        <option>--select--</option>
                                            <%
                                            try{
                                              ResultSet r=Queries.getExecuteQuery("select * from c_form");
                                                while(r.next()){
                                               %>
                                               <option value="<%=r.getString("reg_no")%>"><%=r.getString("reg_no")%></option> 
