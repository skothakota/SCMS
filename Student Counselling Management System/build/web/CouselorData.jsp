				...
				<div class="row">
					...
					<div class="col-sm-10 text-right menu-1">
						<ul>
							...
							<li  class="active"><a href="CouselorData.jsp">FeedBack</a></li>
		...
		<aside id="fh5co-hero">
			<div class="flexslider">
				<ul class="slides">
                                    ...
                                    if(cid!=null){
                                    %>
                                    <form action="AcceptFeed.jsp" method="post"> 
                                     <table border="1">
                                         <tr><th>FeedBack ID</th><td><input type="text" name="id" value="<%=cid%>" readonly=""></td></tr>
                                         <tr>   <th>FeedBack Response</th><td><textarea cols="40" rows="10" name="response" required=""></textarea></td></tr>
                                            <th>Status</th><td><input type="submit" value="Submit" ></td></tr>      
</table>                                      
 </form> 
                                   ...
                                   <%     
                                    ...
                                    %>
                                    <table border="1">
                                        <tr><th>Student Roll NO</th><th>FeedBack</th><th>Status</th></tr>  
                                        <%
                                        try{
                                            ResultSet r=Queries.getExecuteQuery("select * from feedback");
                                            while(r.next()){
                                               %>
                                        <tr>
                                            <td><%=r.getString("rollno")%></td>
                                            <td><textarea cols="40" rows="10"><%=r.getString("feedback")%></textarea></td>
                                            <td><a href="CouselorData.jsp?cid=<%=r.getString("id")%>">Accept</a></td>
                                        </tr>
                                        <%
                                            }
