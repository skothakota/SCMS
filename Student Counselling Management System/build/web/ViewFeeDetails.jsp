		...
		<aside id="fh5co-hero">
			<div class="flexslider">
				<ul class="slides">
                                    ...
                                    try{
                                        ResultSet r=Queries.getExecuteQuery("select * from add_fee where reg_no='"+regno+"'");
                                        %>
                                        <table border="1">
                                            <tr>
                                                <th>Year</th> <th>outstanding</th> <th>instalment-1</th> <th>instalment-2</th> <th>instalment-3</th>
                                            </tr>
                                    <%    
                                    while(r.next()){
                                    %>
...
<a href="SearchStudentAction.jsp?roll_no=<%=regno%>">Back</a>
<%
}catch(Exception e){
out.println(e);
}%>
