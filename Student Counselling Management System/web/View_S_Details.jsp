		...
		<div id="fh5co-intro">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 col-md-pull-2">
                                    <h2><center>Search Student Details</center></h2>
				</div>
			</div>
		</div>
		<aside id="fh5co-hero">
			<div class="flexslider">
				<ul class="slides">
                                    ...
                                    <form action="SearchStudentAction.jsp" method="post">
                                    <table>
                                      <tr><th>Student Registration Number</th><td><input type="text" name="roll_no" required=""></td></tr>
