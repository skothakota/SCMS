	...
	<div class="container">
		...
		<aside id="fh5co-hero">
			<div class="flexslider">
				<ul class="slides">
                                    <h2><center></center></h2>
                                    <form name="reg" action="RegAction.jsp" method="post">
               <table align="center" cellpadding="10px" cellspacing="10px" boder="2px">
                   ...
                   <tr><td>Address</td><td><textarea  name="address" required=""></textarea></td></tr>
                    ...
                    <tr><td>Hobbies</td><td><input type="text" name="hobbies" required=""></td></tr>
                    <tr><td>Parent Name</td><td><input type="text" name="pname" required=""></td></tr>
                    <tr><td>Parent Email</td><td><input type="text" name="pemail" required=""></td></tr>
                    <tr><td>Parent Mobile</td><td><input type="text" name="pmobile" required=""></td></tr>
                    <tr><td>Parent Occupation</td><td><input type="text" name="occupation" required=""></td></tr>
