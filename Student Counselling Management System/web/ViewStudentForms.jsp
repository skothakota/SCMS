			...
			<div class="flexslider">
				<ul class="slides">
			   		 ...
			   		 <style>
                                    ...
                                    try{
                                        ResultSet r=Queries.getExecuteQuery("select * from c_form where reg_no='"+regno+"'");
                                    if(r.next()){
                                    %>
                                     <table>
                                            <tr><th>1. Name Of The Student</th><td>:<input type="text" name="student_name" value="<%=r.getString(2)%>" readonly=""></td></tr>
                                        ...
                                        <tr><th>11. SSC Marks</th><td>:<input type="text" name="ssc_marks"  value="<%=r.getString(19)%>" readonly=""></td></tr>
                                         ...
                                         <tr><a href="ViewFeeDetails1.jsp?regno=<%=r.getString(3)%>">View Fee Details</a></tr>,
                                     <tr style="margin-left:100px;"><a href="GenerateReport.jsp?regno=<%=r.getString(3)%>">Generate Report</a></tr>
                                        </table>
                                        <%}
}catch(Exception e){
out.println(e);
